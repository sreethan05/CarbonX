-- ==============================================================================
-- CarbonX - Complete Consolidated Supabase Schema & Migration Script
-- ==============================================================================
-- Safe to run on a brand new Supabase project OR on an existing project.
...
do $$
begin
  raise notice 'CarbonX schema update completed successfully!';
end $$;
